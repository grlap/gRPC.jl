# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-05-06T15:06:40.461
...
GetFeature(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "GetFeature", Point, Feature, input_object)

ListFeatures(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "ListFeatures", Rectangle, AbstractChannel{Feature}, input_object)

RecordRoute(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "RecordRoute", AbstractChannel{Point}, RouteSummary, input_object)

RouteEcho(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "RouteEcho", RouteNote, RouteNote, input_object)

RouteChat(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "RouteChat", AbstractChannel{RouteNote}, AbstractChannel{RouteNote}, input_object)

TerminateServer(channel, input_object) =
    grpc_client_call(channel, _RouteGuide_const, "TerminateServer", Empty, Empty, input_object)
