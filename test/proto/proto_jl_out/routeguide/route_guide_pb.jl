# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-03-04T19:01:01.416
...
[
    ("GetFeature", 1, Point, Feature),
    ("ListFeatures", 2, Rectangle, AbstractChannel{Feature}),
    ("RecordRoute", 3, AbstractChannel{Point}, RouteSummary),
    ("RouteEcho", 4, RouteNote, RouteNote),
    ("RouteChat", 5, AbstractChannel{RouteNote}, AbstractChannel{RouteNote}),
    ("TerminateServer", 6, Empty, Empty),
] # const _RouteGuide_methods
