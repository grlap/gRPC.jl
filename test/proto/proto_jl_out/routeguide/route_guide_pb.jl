# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-05-03T16:51:07.551
# original file: /home/greg/GitHub/Personal/gRPC.jl/test/proto/route_guide.proto (proto3 syntax)
...
GetFeature(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "GetFeature", Point, Feature, controller, input_instance)

ListFeatures(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "ListFeatures", Rectangle, AbstractChannel{Feature}, controller, input_instance)

RecordRoute(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "RecordRoute", AbstractChannel{Point}, RouteSummary, controller, input_instance)

RouteEcho(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "RouteEcho", RouteNote, RouteNote, controller, input_instance)

RouteChat(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "RouteChat", AbstractChannel{RouteNote}, AbstractChannel{RouteNote}, controller, input_instance)

TerminateServer(channel, controller, input_instance) =
    call_method(channel, _RouteGuide_const, "TerminateServer", Empty, Empty, controller, input_instance)
