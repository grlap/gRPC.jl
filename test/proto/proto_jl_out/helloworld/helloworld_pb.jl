# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-03-03T18:47:48.377
...
# SERVICE: Greeter
using gRPC
const _Greeter_methods = gRPC.MethodDescriptor[
    gRPC.MethodDescriptor("SayHello", 1, HelloRequest, HelloReply),
...
SayHello(stub::GreeterBlockingStub, controller::gRPC.ProtoRpcController, inp) =
