# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-05-03T16:51:07.465
...
SayHello(channel, controller, input_instance) =
    call_method(channel, _Greeter_const, "SayHello", HelloRequest, HelloReply, controller, input_instance)
