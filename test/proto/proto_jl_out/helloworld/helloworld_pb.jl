# Autogenerated using ProtoBuf.jl v1.0.10 on 2023-03-05T12:48:47.833
...
SayHello(stub_impl, controller, input_instance) =
    call_method(stub_impl, "SayHello", HelloRequest, HelloReply, controller, input_instance)
